...
public interface MovieService extends IGenericCrudService<Long, Movie> {
    ...
    /*
The MovieService interface extends IGenericCrudService<Movie>, which means it inherits all the common
CRUD operations for the Movie entity, such as save(), findById(), findAll(), update(), and delete().

By doing this, you can keep the MovieServiceImpl class focused on business logic specific to movies while reusing
